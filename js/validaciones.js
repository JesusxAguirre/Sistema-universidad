...
function validar() {
	...
	//Eliminar disabled al enviar formulario;
	if (document.querySelector('form input[disabled]')) {
		document.querySelector('form input[disabled]').removeAttribute("disabled");
	}
	return true;
}
